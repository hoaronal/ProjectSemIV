...
<spring:url value="/quan-tri/qua-tang/xoa" var="deleteGiftAction"/>
<spring:url value="/quan-tri/qua-tang/cap-nhat" var="editGiftAction"/>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    <h4 class="card-title"><spring:message code="label.listGift"/></h4>
                    <a style="float: right" href="<%=request.getContextPath()%>/quan-tri/qua-tang/them-moi"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title" id="myModalLabel" s><i
                                                                    ...
                                                                    style="color: orange">warning</i> Xóa quyền!
                                                            </h4>
                                                        </div>
                                                        <div class="modal-body text-center">
                                                            <h5>Bạn có muốn xóa quyền có mã là ${item.id}? </h5>
                                                        </div>
                                                        <div class="modal-footer text-center">
                                                            <a class="btn btn-default" data-dismiss="modal"
                                                               style="margin: 0px !important;">Hủy</a>
                                                            <a href="<%=request.getContextPath()%>${deleteGiftAction}/${item.id}"
                                    ...
                                    <div class="dataTables_paginate paging_full_numbers" id="datatables_paginate">
                                        <ul class="pagination">
                                            <li class="paginate_button first " id="datatables_first">
                                                <a href="<%=request.getContextPath()%>/quan-tri/qua-tang/danh-sach-qua-tang/${listItem.firstPage}">Trang
                                                    đầu</a>
                                            </li>
                                            <li class="paginate_button previous" id="datatables_previous">
                                                <a href="<%=request.getContextPath()%>/quan-tri/qua-tang/danh-sach-qua-tang/<c:out value="${page - 1}"/>?keySearch=<c:out value="${keySearch}"/>">Quay lại</a>
                                            </li>
                                            <c:forEach var="page" items="${listItem.pages}">
                                                <li class="paginate_button ${listItem.currentPage == page?"active":""}">
                                                    <a href="<%=request.getContextPath()%>/quan-tri/qua-tang/danh-sach-qua-tang/<c:out value="${page}"/>?keySearch=<c:out value="${keySearch}"/>"
                                                       data-dt-idx="2" tabindex="0">${page}</a>
                                                </li>
                                            </c:forEach>

                                            <li class="paginate_button next" id="datatables_next"><a
                                                    href="<%=request.getContextPath()%>/quan-tri/qua-tang/danh-sach-qua-tang/<c:out value="${page + 1}"/>?keySearch=<c:out value="${keySearch}"/>"
                                                    aria-controls="datatables" data-dt-idx="6" tabindex="0">Tiếp
                                                theo</a>
                                            </li>
                                            <li class="paginate_button last" id="datatables_last">
                                                <a href="<%=request.getContextPath()%>/quan-tri/qua-tang/danh-sach-qua-tang/${listItem.lastPage}">Trang
                                                    cuối</a>
                                            </li>
                                        </ul>
                                    </div>
...
<script type="text/javascript">
    window.onload = function() {
        ...
        document.getElementById("listGiftClass").classList.add('active');
    };
</script>