        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    <h4 class="card-title"><spring:message code="label.listNews"/></h4>
                    <a style="float: right" href="<%=request.getContextPath()%>/quan-tri/tin-tuc/them-moi"
                    ...
                    <div class="material-datatables">
                        <div id="datatables_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="datatables"
                                           ...
                                           cellspacing="0" width="100%" style="width: 100%;" News="grid"
                                        ...
                                        <c:forEach var="item" items="${listItem.item}">
                                            <tr News="row" class="odd" id="rowRecord">
                                                <td tabindex="0" class="sorting_1"><c:out value="${item.id}"/></td>
                                                <td class="title" id="title<c:out value="${item.id}"/>"><c:out
                                                        value="${item.title}"/></td>
                                            ...
                                            <div class="modal fade" style="margin-top: 50px"
                                                 id="smallAlertModal${item.id}" tabindex="-1" News="dialog"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title" id="myModalLabel" s><i
                                                                    ...
                                                                    style="color: orange">warning</i> Xóa tin tức!
                                                            </h4>
                                                        </div>
                                                        <div class="modal-body text-center">
                                                            <h5>Bạn có muốn xóa tin tức có mã là ${item.id}? </h5>
                                                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="dataTables_info" id="datatables_info" News="status" aria-live="polite">
...
<script type="text/javascript">
    window.onload = function() {
        ...
        document.getElementById("listNewsClass").classList.add('active');
    };
</script>