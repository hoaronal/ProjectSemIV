...
<spring:url value="/quan-tri/phu-kien/cap-nhat/luu" var="editAccessoriesAction"/>

<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form:form id="myform" action="${editAccessoriesAction}" method="post" modelAttribute="accessories"
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="form-group label-floating is-empty ">
                                    ...
                                    <div class="test" id="accessoriesNameBorder">
                                        <form:input path="name" id="accessoriesName" cssClass="form-control ${not empty msgAccessoriesName?'errors':''}"/>
                                    </div>
