        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    <h4 class="card-title"><spring:message code="label.listTransaction"/></h4>
                    <div class="toolbar">
                                ...
                                <div class="col-sm-12">
                                    <table id="datatables"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatables" rowspan="1"
                                                colspan="1" aria-label="Position: activate to sort column ascending">
                                                <spring:message code="label.transactionDate"/>
                                            </th>
...
<script type="text/javascript">
    window.onload = function() {
        ...
        document.getElementById("listTransactionClass").classList.add('active');
    };
</script>