...
public class Province implements java.io.Serializable {
    ...
    public Province(int id, Admin adminByAdminUpdate, Admin adminByAdminCreate, String provinceName, String code,String description, Date createDate, Date updateDate) {
        this.id = id;
