...
<spring:url value="/quan-tri/phu-kien/xoa" var="deleteAccessoriesAction"/>
<spring:url value="/quan-tri/phu-kien/cap-nhat" var="editAccessoriesAction"/>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    <h4 class="card-title"><spring:message code="label.listAccessories"/></h4>
                    <a style="float: right" href="<%=request.getContextPath()%>/quan-tri/phu-kien/them-moi"
                    ...
                    <div class="material-datatables">
                        <div id="datatables_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="datatables"
                                           ...
                                           cellspacing="0" width="100%" style="width: 100%;" Accessories="grid"
                                        ...
                                        <c:forEach var="item" items="${listItem.item}">
                                            <tr Accessories="row" class="odd" id="rowRecord">
                                                <td tabindex="0" class="sorting_1"><c:out value="${item.id}"/></td>
                                                <td class="accessoriesname" id="accessoriesname<c:out value="${item.id}"/>"><c:out
                                                        value="${item.name}"/></td>
                                                <td><c:out value="${item.detail}"/></td>
                                                <td class="text-right">
                                                    <a href="" class="btn btn-simple btn-info btn-icon like"><i
                                                            class="material-icons">favorite</i></a>
                                                    <a href="${editAccessoriesAction}/${item.id}"
                                            ...
                                            <div class="modal fade" style="margin-top: 50px"
                                                 id="smallAlertModal${item.id}" tabindex="-1" Accessories="dialog"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title" id="myModalLabel" s><i
                                                                    ...
                                                                    style="color: orange">warning</i> Xóa phụ kiện!
                                                            </h4>
                                                        </div>
                                                        <div class="modal-body text-center">
                                                            <h5>Bạn có muốn xóa phụ kiện có mã là ${item.id}? </h5>
                                                        </div>
                                                        <div class="modal-footer text-center">
                                                            <a class="btn btn-default" data-dismiss="modal"
                                                               style="margin: 0px !important;">Hủy</a>
                                                            <a href="<%=request.getContextPath()%>${deleteAccessoriesAction}/${item.id}"
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="dataTables_info" id="datatables_info" Accessories="status" aria-live="polite">
                                    ...
                                    <div class="dataTables_paginate paging_full_numbers" id="datatables_paginate">
                                        <ul class="pagination">
                                            <li class="paginate_button first " id="datatables_first">
                                                <a href="<%=request.getContextPath()%>/quan-tri/phu-kien/danh-sach-phu-kien/${listItem.firstPage}">Trang
                                                    đầu</a>
                                            </li>
                                            <li class="paginate_button previous" id="datatables_previous">
                                                <a href="<%=request.getContextPath()%>/quan-tri/phu-kien/danh-sach-phu-kien/<c:out value="${page - 1}"/>?keySearch=<c:out value="${keySearch}"/>">Quay lại</a>
                                            </li>
                                            <c:forEach var="page" items="${listItem.pages}">
                                                <li class="paginate_button ${listItem.currentPage == page?"active":""}">
                                                    <a href="<%=request.getContextPath()%>/quan-tri/phu-kien/danh-sach-phu-kien/<c:out value="${page}"/>?keySearch=<c:out value="${keySearch}"/>"
                                                       data-dt-idx="2" tabindex="0">${page}</a>
                                                </li>
                                            </c:forEach>

                                            <li class="paginate_button next" id="datatables_next"><a
                                                    href="<%=request.getContextPath()%>/quan-tri/phu-kien/danh-sach-phu-kien/<c:out value="${page + 1}"/>?keySearch=<c:out value="${keySearch}"/>"
                                                    aria-controls="datatables" data-dt-idx="6" tabindex="0">Tiếp
                                                theo</a>
                                            </li>
                                            <li class="paginate_button last" id="datatables_last">
                                                <a href="<%=request.getContextPath()%>/quan-tri/phu-kien/danh-sach-phu-kien/${listItem.lastPage}">Trang
                                                    cuối</a>
                                            </li>
                                        </ul>
                                    </div>
...
<script type="text/javascript">
    window.onload = function() {
        ...
        document.getElementById("listAccessoriesClass").classList.add('active');
    };
</script>